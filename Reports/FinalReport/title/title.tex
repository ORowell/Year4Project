...
\includegraphics[width=8cm]{title/UoB.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
...
\textsc{\LARGE MSci Fourth Year Project}\\[1.5cm] % Name of your university/college
